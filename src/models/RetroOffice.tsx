...
export function RetroOfficeModel(props: ThreeElements['group']) {
  const { nodes, materials } = useGLTF('/models/retro-office/scene.gltf') as RetroOfficeGLTF
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <group position={[1.325, -4.639, 0.135]} rotation={[-0.033, 0.043, -1.938]} scale={0.08}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[0.221, -0.834, 1.811]} rotation={[-Math.PI / 2, 0, -1.453]} scale={0.163}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[3.142, -0.668, 0.231]} rotation={[0, 0, -0.637]} scale={0.225}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[2.042, -4.645, 0.075]} rotation={[0, 0, -Math.PI / 2]} scale={0.079}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[0.039, -0.837, 0.524]} rotation={[0, 0, -Math.PI]} scale={0.404}>
          <mesh
            castShadow
            receiveShadow
        ...
        {/* Chair */}
        <group position={[-1.943, -2.64, 0.248]} rotation={[0, 0, 2.087]} scale={0.381}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[0.445, -4.608, 0.111]} rotation={[0, 0, 0.977]} scale={0.104}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[-3.243, -4.688, 0.076]} rotation={[0, 0, Math.PI / 4]} scale={0.909}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[1.258, -0.837, 0.524]} rotation={[0, 0, -Math.PI]} scale={0.404}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[1.44, -0.834, 1.811]} rotation={[-Math.PI / 2, 0, 0.027]} scale={0.163}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[1.073, -0.834, 1.811]} rotation={[-Math.PI / 2, 0, -2.511]} scale={0.163}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[2.119, -0.344, 1.695]} rotation={[Math.PI, 0, 0.027]} scale={0.163}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[-2.525, -4.536, 0.12]} rotation={[0, 0, Math.PI / 4]} scale={0.398}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[-1.657, -4.709, 0.259]} rotation={[0, 0, -1.865]} scale={0.055}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[2.119, -0.344, 1.772]} rotation={[Math.PI, 0, 0.027]} scale={0.163}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[2.32, -0.584, 1.695]} rotation={[Math.PI, 0, 0.947]} scale={0.163}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[-3.462, -2.696, 0.248]} rotation={[0, 0, 1.027]} scale={0.381}>
          <mesh
            castShadow
            receiveShadow
        ...
        <group position={[-2.29, -0.563, 1.208]} rotation={[0, 0, -0.546]} scale={0.398}>
          <mesh
            castShadow
            receiveShadow
